        ...
        <div className={ styles.infooter }>
          ...
          <div className={ styles.provide }>
            ...
            <ul>
              ...
              <li>
                <span className={ styles.spContent1 }>
                  <StyleLink underline='none' color='inherit' href='https://docs.ibsheet.com/ibchart/v1/manual/#docs/intro/feature'>
                    IBChart Manual
                  </StyleLink>
                </span>
                <span className={ styles.spContent2 }>
              ...
              <li>
                <span className={ styles.spContent1 }>
                  <StyleLink underline='none' color='inherit' href='https://ibsheet.com/v8/ibchart/html/examples.html'>
                    IBChart Sample
                  </StyleLink>
                </span>
                <span className={ styles.spContent2 }>
          ...
          <div className={ styles.footfloor }>
            <Typography variant='subtitle1' align='center' color='textSecondary' component='p'>
              &copy; {new Date().getFullYear()} IBChart React Guide Sample
            </Typography>
            <Copyright />
          </div>
        </div>
